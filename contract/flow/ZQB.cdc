...
pub contract ZQB: FungibleToken {
    ...
    // Total supply of zqb in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        destroy() {
            ZQB.totalSupply = ZQB.totalSupply - self.balance
        }
    }
    ...
    //
    pub fun createEmptyVault(): @ZQB.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @ZQB.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
            }
            ZQB.totalSupply = ZQB.totalSupply + amount
    ...
    pub resource Administrator {
        ...
        // transactions/zqb/minter/setup_zqb_minter.cdc
        // then the admin account running:
        // transactions/zqb/admin/deposit_zqb_minter.cdc
        //
    ...
    init() {
        self.AdminStoragePath = /storage/fzqbAdmin
        self.MinterProxyPublicPath = /public/fzqbMinterProxy
        self.MinterProxyStoragePath = /storage/fzqbMinterProxy
